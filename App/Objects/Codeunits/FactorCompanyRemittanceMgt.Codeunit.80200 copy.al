...
//     //     if i = 0 then
//     //         i := Params.IndexOf(GenJnlFilter2);
//     //     if i = 0 then
//     //         exit;
...
//     //         if not SingleInstance.GetRecordIDs().Contains(Rec.RecordID) then
...
//     //         case true of
//     //             PrinterSelection.Get(UserId(), ReportID):
//     //                 Report.Print(ReportID, '', PrinterSelection."Printer Name", RecordRef);
//     //             PrinterSelection.Get(UserId(), 0):
//     //                 Report.Print(ReportID, '', PrinterSelection."Printer Name", RecordRef);
//     //             else
//     //                 Report.Print(ReportID, '', '', RecordRef);
//     //         end;
...
//     //         DataCompression.AddEntry(IStream, StrSubstNo('Report %1 - %2.pdf', ReportID, AllObjWithCaption."Object Caption"));
//     //         Clear(TempBlob);
//     //         FilterText.Clear();
//     //     end;
...
//     // [EventSubscriber(ObjectType::Table, Database::"Gen. Journal Line", "OnAfterModifyEvent", '', true, true)]
//     // local procedure GenJournalLineOnAfterModifyEvent(var Rec: Record "Gen. Journal Line")
//     // var
//     //     GenJnlLine: Record "Gen. Journal Line";
//     // begin
//     //     exit;
//     //     if not SingleInstance.GetDisableReportOutput() then
//     //         exit;

//     //     GenJnlLine.SetRange("Journal Template Name", Rec."Journal Template Name");
//     //     GenJnlLine.SetRange("Journal Batch Name", Rec."Journal Batch Name");
//     //     GenJnlLine.SetFilter("Line No.", '<>%1', Rec."Line No.");
//     //     GenJnlLine.SetRange("Shortcut Dimension 1 Code", Rec."Shortcut Dimension 1 Code");
...
//     //     GenJnlLine.SetRange("Document Date", Rec."Document Date");
...
//     // GenJnlFilter2: Label '<DataItem name="GenJnlLine">VERSION(1) SORTING(Field1,Field51,Field2) WHERE(';
